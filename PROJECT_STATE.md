...
| Phase | 상태 | 내용 |
|---|---|---|
| **P1** | 구현·검증 완료, 병합 대기 | 사용자 로컬 시각 설정 · 멱등 자동 일기 예약 · 홈 예약 문구 |
| **P2** | 대기 | 일반명사·시간대어 불용어 |
| **P3** | 대기 | 메모 임베딩 · 근거 기반 회고 RAG |
| **P4** | 대기 | 사진 업로드 · 실패/취소 시 기록 보존 |
| **P5** | 대기 | 기억 잠금 UI · 탐지/검색/일기 실제 제외 |
| **P6** | 대기 | 요약 슬롯 기반 공유 카드 PNG |
